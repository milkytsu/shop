...
<body>
            ...
            <div id="pad-wrapper">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <button class="btn btn-success"><i class="icon-plus"></i>&nbsp;添加分类</button>
                    </div>
                </div>

                <div class="row-fluid">
                    <div class="accordion" id="cate_root">
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a id="cate_1" class="accordion-toggle" href="#">cate 1</a>
                            </div>
                            <div id="cate_1_body" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a id="cate_1_sub_1" class="accordion-toggle" href="#">
                                                sub cate 1
                                            </a>
                                        </div>
                                        <div id="cate_1_sub_1_body" class="accordion-body collapse">
                                            <div class="accordion-inner">
                                                xxxx
                                            </div>
                                            <div class="accordion-inner">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a id="cate_1_sub_2" class="accordion-toggle" href="#">
                                                sub cate 1
                                            </a>
                                        </div>
                                        <div id="cate_1_sub_2_body" class="accordion-body collapse">
                                            <div class="accordion-inner">
                                                xxxx
                                            </div>
                                            <div class="accordion-inner">
    ...
    <script type="text/javascript">
        ...
        {
            $('#cate_1_body').collapse('toggle')
            return false;
        })
        $('#cate_1_sub_1').click(function()
        {
            $('#cate_1_sub_1_body').collapse('toggle')
            return false
        })
        $('#cate_1_sub_2').click(function()
        {
            $('#cate_1_sub_2_body').collapse('toggle')
            return false
        })
    </script>
